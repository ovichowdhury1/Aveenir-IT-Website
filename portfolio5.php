							...
							<div class="blogs blog-4 mb-40">
								<div class="blog__thumb mb-55 ">
									<a href="news-details.php">
										<img class="img-fluid  w-100" src="img/hospitalmanagement.jpg" alt="Blog Img">
									</a>
                                ...
                                <a class="theme_btn mt-20 " href="inventory-demo-page.php" style="border-radius: 10px;">Demo</a>                                </div>                                
							</div>
						</div>
					</div>
				</div>
