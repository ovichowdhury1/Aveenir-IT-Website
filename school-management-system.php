...
<body>
	...
	<main>
				...
				<div class="row align-items-center pt-140 pt-xs-60">
					<div class="col-lg-6 col-md-5 text-md-end">
						<ul class="breadcrumb list-none breadcrumb-bg float-start">
							...
							<li class="active text-heding fw-bold" aria-current="page">Inventory Management</li>
						</ul>
					</div>
				</div>
			</div>
		...
		<!--page-title-area end-->
		<!--page-title-area start-->
		<section class="portfolio-area pt-50 pb-90 pt-md-30 pb-md-30 pt-xs-30 pb-xs-30">
			<div class="container">
              <div class="row">
                <div class="card cards card-2 text-center " style="max-width: 100%;width:500px">
                    <div class="card-body section-title mt-5">
                        <h5 class="card-title">Admin Panel</h5>
                        <div class="bar mb-5"></div>
                        <a href="school-management-system-screenshort.php"class="btn btn-primary mt-5">screenshort</a>
                        <a href="https://schooldemo.aveenirit.com/admin/login" class="btn btn-primary mt-5">Demo</a>
                    </div>
                </div> 
                <div class="card cards card-2 text-center " style="max-width: 100%;width:500px">
                    <div class="card-body section-title mt-5">
                        ...
                        <div class="bar mb-5"></div>
                        <a href="school-management-system-screenshort1.php"class="btn btn-primary mt-5">screenshort</a>
                        <a href="https://schooldemo.aveenirit.com/teacher/login" class="btn btn-primary mt-5">Demo</a>
                    </div>
                </div> 
                <div class="card cards card-2 text-center " style="max-width: 100%;width:500px">
                    <div class="card-body section-title mt-5">
                        ...
                        <div class="bar mb-5"></div>
                        <a href="school-management-system-screenshort2.php"class="btn btn-primary mt-5">screenshort</a>
                        <a href="https://schooldemo.aveenirit.com/login" class="btn btn-primary mt-5">Demo</a>
                    </div>
                </div>
