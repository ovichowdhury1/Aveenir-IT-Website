...
<body>
    ...
    <main>
                ...
                <div class="row align-items-center pt-140 pt-xs-60">
                    <div class="col-lg-6 col-md-5 text-md-end">
                        <ul class="breadcrumb list-none breadcrumb-bg float-start">
                            ...
                            <li class="active text-heding fw-bold" aria-current="page">Screenshort</li>
                        </ul>
                    </div>
                </div>
            </div>
        ...
        <section class="portfolio-area pt-110 pb-90 pt-md-60 pb-md-30 pt-xs-60 pb-xs-30">
            ...
            <a href="img/inventory/admin-sign-in-page.png" class="col-6 col-md-3 mb-4">
                <img src="img/inventory/admin-sign-in-page.png" class="img-fluid">
                 <h5 style="text-align: center;" class="m-4">Admin Sign-In Page</h5>
            </a>
            <a href="img/School-Management-System/admin/dashboard.png" class="col-6 col-md-3 mb-4">
                <img src="img/School-Management-System/admin/dashboard1.png" class="img-fluid">
                 <h5 style="text-align: center;" class="m-4">Dashboard Page</h5>
            </a>
            <a href="img/School-Management-System/admin/Student-Aplication-Form-Setup.png" class="col-6 col-md-3 mb-4">
                <img src="img/School-Management-System/admin/Student-Aplication-Form-Setup1.png" class="img-fluid">
                 <h5 style="text-align: center;" class="m-4">Student Aplication Form Setup</h5>
            </a>
            <a href="img/School-Management-System/admin/Teacher Aplication Form Setup.png" class="col-6 col-md-3 mb-4">
                <img src="img/School-Management-System/admin/Teacher Aplication Form Setup1.png" class="img-fluid">
                 <h5 style="text-align: center;" class="m-4">Teacher Aplication Form Setup</h5>
            </a>
            <a href="img/School-Management-System/admin/Online Aplications.png" class="col-6 col-md-3 mb-4">
                <img src="img/School-Management-System/admin/Online Aplications1.png" class="img-fluid">
                 <h5 style="text-align: center;" class="m-4">Online Aplications</h5>
            </a>
            <a href="img/School-Management-System/admin/Teacher Aplications.png" class="col-6 col-md-3 mb-4">
                <img src="img/School-Management-System/admin/Teacher-Aplications500x500.png" class="img-fluid">
                 <h5 style="text-align: center;" class="m-4">Teacher Aplications</h5>
            </a>
            <a href="img/School-Management-System/admin/tution-fee.png" class="col-6 col-md-3 mb-4">
                <img src="img/School-Management-System/admin/Tution fee1.png" class="img-fluid">
                 <h5 style="text-align: center;" class="m-4">Tution fee</h5>
            </a>
            <a href="img/School-Management-System/admin/Teacher salary.png" class="col-6 col-md-3 mb-4">
                <img src="img/School-Management-System/admin/Teacher salary (1).png" class="img-fluid">
                 <h5 style="text-align: center;" class="m-4">Teacher salary</h5>
            </a>
            <a href="img/School-Management-System/admin/Account Status (1).png" class="col-6 col-md-3 mb-4">
                <img src="img/School-Management-System/admin/account-status.png" class="img-fluid">
                 <h5 style="text-align: center;" class="m-4">Account Status</h5>
            </a>
            <a href="img/School-Management-System/admin/teacher attendence.png" class="col-6 col-md-3 mb-4">
                <img src="img/School-Management-System/admin/teacher attendence1.png" class="img-fluid">
                 <h5 style="text-align: center;" class="m-4">Teacher Attendence</h5>
            </a>
            <a href="img/School-Management-System/admin/Class Teacher Set.png" class="col-6 col-md-3 mb-4">
                <img src="img/School-Management-System/admin/Class Teacher Set1.png" class="img-fluid">
                 <h5 style="text-align: center;" class="m-4">Class Teacher Set</h5>
            </a>
