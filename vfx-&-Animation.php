				...
				<div class="row align-items-center pt-140 pt-xs-60">
					<div class="col-lg-6 col-md-5 text-md-end">
						<ul class="breadcrumb list-none breadcrumb-bg float-start">
							...
							<li class="active text-heding fw-bold" aria-current="page">VFX & Animation</li>
						</ul>
					</div>
				</div>
			</div>
				...
				<div class="row align-items-center">
					<div class="col-lg-6">
						<div class="about-text-wrapper2 mb-30 pr-75">
							<h6 class="semi-title semi-title2">VFX & ANIMATION</h6>
							...
							<p class="paragraph-title" style="text-align: justify;">We offer state-of-the-art visual
								effects and animation services to bring your ideas to life. Our professional VFX and
								animation team will create cinematic experience and make your project stand out.
					...
					<div class="col-lg-6">
						<div class="about-img-wrapper mb-30">
							<img class="img-fluid" src="img/VFX&animation.jpg" alt="icon">
						</div>
					</div>
				</div>
			</div>
