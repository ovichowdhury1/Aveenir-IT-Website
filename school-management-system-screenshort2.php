        ...
        <section class="portfolio-area pt-110 pb-90 pt-md-60 pb-md-30 pt-xs-60 pb-xs-30">
            ...
            <a href="img/inventory/admin-sign-in-page.png" class="col-6 col-md-3 mb-4">
                <img src="img/inventory/admin-sign-in-page.png" class="img-fluid">
                 <h5 style="text-align: center;" class="m-4">Student Sign-In Page</h5>
            </a>
            <a href="img/School-Management-System/student/dashboard.png" class="col-6 col-md-3 mb-4">
                <img src="img/School-Management-System/student/dashboard (1).png" class="img-fluid">
