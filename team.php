...
<body>
	...
	<main>
		...
		<!--page-title-area end-->
		<!--DEVELOPER-TEAM-team-area start-->
			...
			<div class="container">
				<div class="row">
					...
					<div class="col-lg-3 col-md-6">
						<div class="team-wrapper text-center mb-45">
							<div class="team-thumb">
								<img src="img/fahim.png" alt="Image">
							</div>
							<div class="team-content">
					...
					<div class="col-lg-3 col-md-6">
						<div class="team-wrapper text-center mb-45">
							<div class="team-thumb">
								<img src="img/samia.png" alt="Image">
							</div>
							<div class="team-content">
					...
					<div class="col-lg-3 col-md-6">
						<div class="team-wrapper text-center mb-45">
							<div class="team-thumb">
								<img src="img/ovichowdhury.png" alt="Image">
							</div>
							<div class="team-content">
					...
					<div class="col-lg-3 col-md-6">
						<div class="team-wrapper text-center mb-45">
							<div class="team-thumb">
								<img src="img/Saddam.png" alt="Image">
							</div>
							<div class="team-content">
								<h4 class="sub-title text-heding2">MD. Saddam Hossain</h4>
					...
					<div class="col-lg-3 col-md-6">
						<div class="team-wrapper text-center mb-45">
							<div class="team-thumb">
								<img src="img/parvez.png" alt="Image">
							</div>
							<div class="team-content">
		...
		<!--DEVELOPER TEAM-area end-->
		<!--GRAPHICS-TEAM-area start-->
		<section class="team-area2 pt-120 pb-70 pt-md-60 pb-md-30 pt-xs-60 pb-xs-30">
			<div class="container">
				<div class="row">
					<div class="about-text-wrapper2 mb-30 pr-75 section-title mb-50">
						<h6 class="semi-title semi-title2 text-center">CREATIVE TEAM
						</h6>
						<div class="bar"></div>
					</div>
					<div class="col-lg-3 col-md-6">
						<div class="team-wrapper text-center mb-45">
							<div class="team-thumb">
								<img src="img/musfiq.png" alt="Image">
							</div>
							<div class="team-content">
								<h4 class="sub-title text-heding2">Mushfiqur Rahman</h4>
								<h6 class="theme-col">Graphics Designer</h6>
					...
					<div class="col-lg-3 col-md-6">
						<div class="team-wrapper text-center mb-45">
							<div class="team-thumb">
								<img src="img/eha.png" alt="Image">
							</div>
							<div class="team-content">
								<h4 class="sub-title text-heding2">Eha Nawar</h4>
								<h6 class="theme-col">Cartoon Artist</h6>
					...
					<div class="col-lg-3 col-md-6">
						<div class="team-wrapper text-center mb-45">
							<div class="team-thumb">
								<img src="img/maruf.png" alt="Image">
							</div>
							<div class="team-content">
								<h4 class="sub-title text-heding2">Maruf Samir</h4>
								<h6 class="theme-col">Architech and 3d Artist</h6>
					...
					<div class="col-lg-3 col-md-6">
						<div class="team-wrapper text-center mb-45">
							<div class="team-thumb">
								<img src="img/jamiul.png" alt="Image">
							</div>
							<div class="team-content">
								<h4 class="sub-title text-heding2">Jamiul Hossain</h4>
								<h6 class="theme-col">Motion Artist and Video Editor</h6>
					...
					<div class="col-lg-3 col-md-6">
						<div class="team-wrapper text-center mb-45">
							<div class="team-thumb">
								<img src="img/abdur-rahman.png" alt="Image">
							</div>
							<div class="team-content">
								<h4 class="sub-title text-heding2">Abdur Rahman</h4>
								<h6 class="theme-col">Animator</h6>
		...
		<!--GRAPHICS-TEAM-area end-->
		<!--MANAGEMENT-TEAM-areas tart-->
		<section class="team-area2 pt-120 pb-70 pt-md-60 pb-md-30 pt-xs-60 pb-xs-30">
			<div class="container">
				<div class="row">
					<div class="about-text-wrapper2 mb-30 pr-75 section-title mb-50">
						<h6 class="semi-title semi-title2 text-center">MANAGEMENT TEAM
						</h6>
						<div class="bar"></div>
					</div>
					<div class="col-lg-3 col-md-6">
						<div class="team-wrapper text-center mb-45">
							<div class="team-thumb">
								<img src="img/zhuma.png" alt="Image">
							</div>
							<div class="team-content">
								
								<h4 class="sub-title text-heding2">Admin</h4>
								<h6 class="theme-col">Zhuma khan</h6>
							</div>
						</div>
					</div>
					<div class="col-lg-3 col-md-6">
						<div class="team-wrapper text-center mb-45">
							<div class="team-thumb">
								<img src="img/azmat.png" alt="Image">
							</div>
							<div class="team-content">
								<h4 class="sub-title text-heding2">HR and Operation Manager</h4>
							    <h6 class="theme-col">Sayed Azmatul Quadir </h6>
							</div>
						</div>
					</div>
					<div class="col-lg-3 col-md-6">
						<div class="team-wrapper text-center mb-45">
							<div class="team-thumb">
								<img src="img/srabonti.png" alt="Image">
							</div>
							<div class="team-content">
								
								<h4 class="sub-title text-heding2">Head  of Business Development</h4>
							    <h6 class="theme-col">Suraya Srabonti</h6>
							</div>
						</div>
					</div>
					<div class="col-lg-3 col-md-6">
						<div class="team-wrapper text-center mb-45">
							<div class="team-thumb">
								<img src="img/Ridwan.png" alt="Image">
							</div>
							<div class="team-content">
								
								<h4 class="sub-title text-heding2">Finance Consultant</h4>
							    <h6 class="theme-col">Shaikh Ridwan Rahman</h6>
							</div>
						</div>
					</div>	
				</div>
		...
		<!--MARKETING-TEAM--area start-->
		<section class="team-area2 pt-120 pb-70 pt-md-60 pb-md-30 pt-xs-60 pb-xs-30">
			<div class="container">
				<div class="row">
					<div class="about-text-wrapper2 mb-30 pr-75 section-title mb-50">
						<h6 class="semi-title semi-title2 text-center">MARKETING TEAM
						</h6>
						<div class="bar"></div>
					</div>
					<div class="col-lg-3 col-md-6">
						<div class="team-wrapper text-center mb-45">
							<div class="team-thumb">
								<img src="img/MdMahmudulHasan.png" alt="Image">
							</div>
							<div class="team-content">
								<h4 class="sub-title text-heding2">Md Mahmudul Hasan</h4>
								<h6 class="theme-col">Marketing Manger</h6>
							</div>
						</div>
					</div>
					<div class="col-lg-3 col-md-6">
						<div class="team-wrapper text-center mb-45">
							<div class="team-thumb">
								<img src="img/sarfaraj.png" alt="Image">
							</div>
							<div class="team-content">
								<h4 class="sub-title text-heding2">Md Sarfaraj</h4>
								<h6 class="theme-col">Marketing Executive</h6>
							</div>
						</div>
					</div>
					<div class="col-lg-3 col-md-6">
						<div class="team-wrapper text-center mb-45">
							<div class="team-thumb">
								<img src="img/anisur.png" alt="Image">

							</div>
							<div class="team-content">
								<h4 class="sub-title text-heding2">Md. Anisur Rahman (Raza)</h4>
								<h6 class="theme-col">
									Marketing Executive</h6>
							</div>
						</div>
					</div>
					<div class="col-lg-3 col-md-6">
						<div class="team-wrapper text-center mb-45">
							<div class="team-thumb">
								<img src="img/fahima.png" alt="Image">

							</div>
							<div class="team-content">
								<h4 class="sub-title text-heding2">Fahmida Sultana</h4>
								<h6 class="theme-col">
									Marketing Executive</h6>
							</div>
						</div>
					...
					<div class="col-lg-3 col-md-6">
						<div class="team-wrapper text-center mb-45">
							<div class="team-thumb">
								<img src="img/Nurnnabi1.png" alt="Image">

							</div>
							<div class="team-content">
								<h4 class="sub-title text-heding2">Md. Kazi Nurnnabi</h4>
								<h6 class="theme-col">
									Marketing Executive</h6>
							</div>
						</div>
					...
					<div class="col-lg-3 col-md-6">
						<div class="team-wrapper text-center mb-45">
							<div class="team-thumb">
								<img src="img/pavel.png" alt="Image">

							</div>
							<div class="team-content">
								<h4 class="sub-title text-heding2">Pavel</h4>
								<h6 class="theme-col">
									Marketing Executive</h6>
							</div>
						</div>
