	...
	<main>
		...
		<section class=" pt-120 pb-90 pt-md-60 pb-md-30 pt-xs-60 pb-xs-30 home-4">
			<div class="container">
				...
				<div class="grid1 row align-items-center">
					<div class="col-lg-4 col-md-6 col-sm-6 grid-item cat3 cat4">
						<div class=" mb-30">
							<img class="img-fluid" src="img/office2.jpg" alt="Portfolio Img">
						</div>
					</div>
					<div class="col-lg-4 col-md-6 col-sm-6 grid-item cat3 cat4">
						<div class=" mb-30">
							<img class="img-fluid" src="img/office3.jpg" alt="Portfolio Img">
						</div>
					</div>
					<div class="col-lg-4 col-md-6 col-sm-6 grid-item cat3 cat4">
						<div class=" mb-30">
							<img class="img-fluid" src="img/office4.jpg" alt="Portfolio Img">
						</div>
					</div>
					<div class="col-lg-4 col-md-6 col-sm-6 grid-item cat3 cat4">
						<div class=" mb-30">
							<img class="img-fluid" src="img/office5.jpg" alt="Portfolio Img">
						</div>
					</div>
					<div class="col-lg-4 col-md-6 col-sm-6 grid-item cat3 cat4">
						<div class=" mb-30">
							<img class="img-fluid" src="img/office6.jpg" alt="Portfolio Img">
						</div>
					</div>
					<div class="col-lg-4 col-md-6 col-sm-6 grid-item cat3 cat4">
						<div class=" mb-30">
							<img class="img-fluid" src="img/office7.jpg" alt="Portfolio Img">
						</div>
					</div>
					<div class="col-lg-4 col-md-6 col-sm-6 grid-item cat3 cat4">
						<div class=" mb-30">
							<img class="img-fluid" src="img/office8.jpg" alt="Portfolio Img">
						</div>
					</div>
				</div>
			</div>
