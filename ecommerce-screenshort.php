...
<body>
    ...
    <main>
        ...
        <section class="portfolio-area pt-110 pb-90 pt-md-60 pb-md-30 pt-xs-60 pb-xs-30">
            ...
            <a href="img/ecommerce/dashboard1.png" class="col-6 col-md-3 mb-4">
                <img src="img/ecommerce/dashboard1 (1).png" class="img-fluid">
                 <h5 style="text-align: center;" class="m-4">Dashboard Page</h5>
            </a>
            <a href="img/ecommerce/Add Supplier.png" class="col-6 col-md-3 mb-4">
                <img src="img/ecommerce/Add Supplier (1).png" class="img-fluid">
                 <h5 style="text-align: center;" class="m-4">Add Supplier</h5>
            </a>
            <a href="img/ecommerce/Supplier List.png" class="col-6 col-md-3 mb-4">
                <img src="img/ecommerce/Supplier List (1).png" class="img-fluid">
                 <h5 style="text-align: center;" class="m-4">Supplier List</h5>
            </a>
            <a href="img/ecommerce/Catagory.png" class="col-6 col-md-3 mb-4">
                <img src="img/ecommerce/Catagory (1).png" class="img-fluid">
                 <h5 style="text-align: center;" class="m-4">Catagory</h5>
            </a>
            <a href="img/ecommerce/Catagory List.png" class="col-6 col-md-3 mb-4">
                <img src="img/ecommerce/category-list1.png" class="img-fluid">
                 <h5 style="text-align: center;" class="m-4">Catagory List</h5>
            </a>
            <a href="img/ecommerce/Sub Catagory List.png" class="col-6 col-md-3 mb-4">
                <img src="img/ecommerce/Sub Catagory List (1).png" class="img-fluid">
                 <h5 style="text-align: center;" class="m-4">Sub Catagory List</h5>
            </a>
            <a href="img/ecommerce/product-add.png" class="col-6 col-md-3 mb-4">
                <img src="img/ecommerce/product-add1 (1).png" class="img-fluid">
                 <h5 style="text-align: center;" class="m-4">Product Add</h5>
            </a>
            <a href="img/ecommerce/Product List.png" class="col-6 col-md-3 mb-4">
                <img src="img/ecommerce/Product List (1).png" class="img-fluid">
                 <h5 style="text-align: center;" class="m-4">Product List</h5>
            </a>
            <a href="img/ecommerce/Print Barcode.png" class="col-6 col-md-3 mb-4">
                <img src="img/ecommerce/print-barcode.png" class="img-fluid">
                 <h5 style="text-align: center;" class="m-4">Print Barcode</h5>
            </a>
            <a href="img/ecommerce/Purchase Add (2).png" class="col-6 col-md-3 mb-4">
                <img src="img/ecommerce/purchase Add(3).png" class="img-fluid">
                 <h5 style="text-align: center;" class="m-4">Purchase Add</h5>
            </a>
            
            <a href="img/ecommerce/PURCHASE LIST.png" class="col-6 col-md-3 mb-4">
                <img src="img/ecommerce/PURCHASE LIST (1).png" class="img-fluid">
                 <h5 style="text-align: center;" class="m-4">PURCHASE LIST</h5>
            </a>
            
            <a href="img/ecommerce/Sales Report.png" class="col-6 col-md-3 mb-4">
                <img src="img/ecommerce/Sales Report (1).png" class="img-fluid">
                 <h5 style="text-align: center;" class="m-4">Sales Report</h5>
            </a>
            <a href="img/ecommerce/Purchase Report.png" class="col-6 col-md-3 mb-4">
                <img src="img/ecommerce/Purchase Report (1).png" class="img-fluid">
                 <h5 style="text-align: center;" class="m-4">Purchase Report</h5>
            </a>
        </div>
            </div>
        </section>
