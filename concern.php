				...
				<div class="grid1 row align-items-center">
					<div class="col-lg-4 col-md-6 col-sm-6 grid-item cat2 " style="height: 400px;width: 400px;">
						<div class="portfolio-wrapper2 mb-30">
							<img class="img-fluid" src="img/mindboost.png" alt="Portfolio Img">
					...
					<div class="col-lg-4 col-md-6 col-sm-6 grid-item cat2 " style="height: 400px;width: 400px;">
						<div class="portfolio-wrapper2 mb-30">
							<img class="img-fluid" src="img/edu.png" alt="Portfolio Img">
							<div class="portfolio-content">
								<p>Sister Concern Of Aveenir IT</p>
					...
					<div class="col-lg-4 col-md-6 col-sm-6 grid-item cat2 " style="height: 400px;width: 400px;">
						<div class="portfolio-wrapper2 mb-30">
							<img class="img-fluid" src="img/monarch.png" alt="Portfolio Img">
							<div class="portfolio-content">
								<p>Sister Concern Of Aveenir IT</p>
					...
					<div class="col-lg-4 col-md-6 col-sm-6 grid-item cat2 " style="height: 400px;width: 400px;">
						<div class="portfolio-wrapper2 mb-30">
							<img class="img-fluid" src="img/axiom.png" alt="Portfolio Img">
							<div class="portfolio-content">
								<p>Sister Concern Of Aveenir IT</p>
