				...
				<div class="row align-items-center pt-140 pt-xs-60">
					<div class="col-lg-6 col-md-5 text-md-end">
						<ul class="breadcrumb list-none breadcrumb-bg float-start">
							...
							<li class="active text-heding fw-bold" aria-current="page">School Management System</li>
						</ul>
					</div>
				</div>
			</div>
							...
							<div class="blogs blog-4 mb-40">
								<div class="blog__thumb mb-55 ">
									<a href="news-details.php">
										<img class="img-fluid  w-100" src="img/school-management-system.jpg" alt="Blog Img">
									</a>
									<div class="tag">Pos System</div>
								</div>
                                ...
                                <a class="theme_btn mt-20 " href="school-management-system.php" style="border-radius: 10px;">Demo</a>                                </div>                                
							</div>
						</div>
					</div>
				</div>
