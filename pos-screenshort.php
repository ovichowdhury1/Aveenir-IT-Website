...
<body>
    ...
    <main>
        ...
        <section class="portfolio-area pt-110 pb-90 pt-md-60 pb-md-30 pt-xs-60 pb-xs-30">
            ...
            <a href="img/inventory/dashboard.png" class="col-6 col-md-3 mb-4">
                <img src="img/inventory/dashboard1 .png" class="img-fluid">
                 <h5 style="text-align: center;" class="m-4">Dashboard Page</h5>
            </a>
            <a href="img/inventory/add-supplier.png" class="col-6 col-md-3 mb-4">
                <img src="img/inventory/add-supplier1.png" class="img-fluid">
                 <h5 style="text-align: center;" class="m-4">Add Supplier Page</h5>
            </a>
            <a href="img/inventory/supplier-list.png" class="col-6 col-md-3 mb-4">
                <img src="img/inventory/supplier-list1.png" class="img-fluid">
                 <h5 style="text-align: center;" class="m-4">Supplier List Page</h5>
            </a>
            <a href="img/inventory/product-add-page.png" class="col-6 col-md-3 mb-4">
                <img src="img/inventory/Product Add1.png" class="img-fluid">
                 <h5 style="text-align: center;" class="m-4">Product Add Page</h5>
            </a>
            <a href="img/inventory/Product List.png" class="col-6 col-md-3 mb-4">
                <img src="img/inventory/Product List-1.png" class="img-fluid">
                 <h5 style="text-align: center;" class="m-4">Product List Page</h5>
            </a>
            <a href="img/pos sytem/Print Barcode.png" class="col-6 col-md-3 mb-4">
                <img src="img/pos sytem/Print Barcode1.png" class="img-fluid">
                 <h5 style="text-align: center;" class="m-4">Print Barcode</h5>
            </a>
            <a href="img/inventory/Purchase Add.png" class="col-6 col-md-3 mb-4">
                <img src="img/inventory/Purchase Add1.png" class="img-fluid">
                 <h5 style="text-align: center;" class="m-4">Purchase Add Page</h5>
            </a>
            <a href="img/inventory/PURCHASE LIST.png" class="col-6 col-md-3 mb-4">
                <img src="img/inventory/PURCHASE LIST1.png" class="img-fluid">
                 <h5 style="text-align: center;" class="m-4">PURCHASE LIST Page</h5>
            </a>
            <a href="img/inventory/Sales Report.png" class="col-6 col-md-3 mb-4">
                <img src="img/inventory/Sales Report1.png" class="img-fluid">
                 <h5 style="text-align: center;" class="m-4">Sales Report Page</h5>
            </a>
            <a href="img/inventory/Purchase Report.png" class="col-6 col-md-3 mb-4">
                <img src="img/inventory/Purchase Report1.png" class="img-fluid">
                 <h5 style="text-align: center;" class="m-4">Purchase Report Page</h5>
            </a>
            <a href="img/inventory/User -Management.png" class="col-6 col-md-3 mb-4">
                <img src="img/inventory/User Management1.png" class="img-fluid">
                 <h5 style="text-align: center;" class="m-4">User Management Page</h5>
            </a>
            <a href="img/inventory/User Management2.png" class="col-6 col-md-3 mb-4">
                <img src="img/inventory/User Management3.png" class="img-fluid">
                 <h5 style="text-align: center;" class="m-4">User Management Page</h5>
            </a>
