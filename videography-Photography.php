				...
				<div class="row align-items-center pt-140 pt-xs-60">
					<div class="col-lg-6 col-md-5 text-md-end">
						<ul class="breadcrumb list-none breadcrumb-bg float-start">
							...
							<li class="active text-heding fw-bold" aria-current="page">Videography & Photography Support
							</li>
						</ul>
					</div>
				</div>
				...
				<div class="row align-items-center">
					<div class="col-lg-6">
						<div class="about-text-wrapper2 mb-30 pr-75">
							<h6 class="semi-title semi-title2">Videography & Photography Support</h6>
							...
							<p class="paragraph-title" style="text-align: justify;">
								We provide expert photography and videography services that capture stunning visuals,
								whether you need them for a special event, corporate function, or product marketing
								campaign
							</p>
					...
					<div class="col-lg-6">
						<div class="about-img-wrapper mb-30">
							<img class="img-fluid" src="img/videophotograpghy.jpg" alt="icon">
						</div>
					</div>
				</div>
			</div>
