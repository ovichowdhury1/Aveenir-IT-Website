				...
				<div class="row align-items-center pt-140 pt-xs-60">
					<div class="col-lg-6 col-md-5 text-md-end">
						<ul class="breadcrumb list-none breadcrumb-bg float-start">
							...
							<li class="active text-heding fw-bold" aria-current="page">2D & 3D Animaton</li>
						</ul>
					</div>
				</div>
			</div>
				...
				<div class="row align-items-center">
					<div class="col-lg-6">
						<div class="about-text-wrapper2 mb-30 pr-75">
							<h6 class="semi-title semi-title2">SOFTWARE SOLUTION</h6>
							...
							<p class="paragraph-title" style="text-align: justify;">Lorem Ipsum is simply dummy text of
					...
					<div class="col-lg-12">
						<div class="section-title text-center mb-60">
							...
							<h2 class="sect-title text-heding2 mb-35 text-center" style="font-size: 25px;">Our WEB
								SOLUTION Services That We Offer</h2>
							<div class="bar"></div>
						</div>
					</div>
				</div>
