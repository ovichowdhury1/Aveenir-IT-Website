				...
				<div class="row align-items-center pt-140 pt-xs-60">
					<div class="col-lg-6 col-md-5 text-md-end">
						<ul class="breadcrumb list-none breadcrumb-bg float-start">
							...
							<li class="active text-heding fw-bold" aria-current="page">Graphical Solution</li>
						</ul>
					</div>
				</div>
			</div>
				...
				<div class="row align-items-center">
					<div class="col-lg-6">
						<div class="about-text-wrapper2 mb-30 pr-75">
							<h6 class="semi-title semi-title2">Graphical Solution</h6>
							...
							<p class="paragraph-title" style="text-align: justify;">We offer high-quality,
								visually-appealing, and professional graphics design services for a wide range of
								applications, including branding, marketing materials, and digital media
							</p>
					...
					<div class="col-lg-6">
						<div class="about-img-wrapper mb-30">
							<img class="img-fluid" src="img/graphic-img.jpg" alt="icon">
						</div>
					</div>
				</div>
			</div>
				...
				<div class="row">
					<div class="col-lg-12">
						<div class="section-title text-center mb-60">
							...
							<h2 class="sect-title text-heding2 mb-35 text-center" style="font-size: 25px;">Our Graphical
