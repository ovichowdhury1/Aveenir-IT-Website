...
<body>
    ...
    <main>
        ...
        <section class="portfolio-area pt-110 pb-90 pt-md-60 pb-md-30 pt-xs-60 pb-xs-30">
            ...
            <a href="img/School-Management-System/teacher/teacher-sign-in.png" class="col-6 col-md-3 mb-4">
                <img src="img/School-Management-System/teacher/teacher-sign-in (1).png" class="img-fluid">
                 <h5 style="text-align: center;" class="m-4">Teacher Sign-In Page</h5>
            </a>
            <a href="img/School-Management-System/teacher/dashboard.png" class="col-6 col-md-3 mb-4">
                <img src="img/School-Management-System/teacher/dashboard (1).png" class="img-fluid">
                 <h5 style="text-align: center;" class="m-4">Dashboard Page</h5>
            </a>
            <a href="img/School-Management-System/teacher/schedule.png" class="col-6 col-md-3 mb-4">
                <img src="img/School-Management-System/teacher/schedule (1).png" class="img-fluid">
                 <h5 style="text-align: center;" class="m-4">Schedule</h5>
            </a>
            <a href="img/School-Management-System/teacher/salary.png" class="col-6 col-md-3 mb-4">
                <img src="img/School-Management-System/teacher/salary (1).png" class="img-fluid">
                 <h5 style="text-align: center;" class="m-4">Salary</h5>
            </a>
            <a href="img/School-Management-System/teacher/password.png" class="col-6 col-md-3 mb-4">
                <img src="img/School-Management-System/teacher/password (1).png" class="img-fluid">
                 <h5 style="text-align: center;" class="m-4">Password</h5>
            </a>
        </div>
            </div>
        </section>
