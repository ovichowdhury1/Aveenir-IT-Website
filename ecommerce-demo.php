              ...
              <div class="row">
                <div class="card cards card-2 text-center " style="max-width: 100%;width:500px">
                    <div class="card-body section-title mt-5">
                        ...
                        <a href="ecommerce-screenshort.php"class="btn btn-primary mt-5">screenshort</a>
                        <a href="http://ecommercedemo.aveenirit.com/admin/login" class="btn btn-primary mt-5">Demo</a>
                    </div>
                </div>    
              </div>
            </div>
