				...
				<div class="row align-items-center pt-140 pt-xs-60">
					<div class="col-lg-6 col-md-5 text-md-end">
						<ul class="breadcrumb list-none breadcrumb-bg float-start">
							...
							<li class="active text-heding fw-bold" aria-current="page">Software Development</li>
						</ul>
					</div>
				</div>
			</div>
				...
				<div class="row align-items-center">
					<div class="col-lg-6">
						<div class="about-text-wrapper2 mb-30 pr-75">
							<h6 class="semi-title semi-title2">SOFTWARE DEVELOPMENT</h6>
							...
							<p class="paragraph-title" style="text-align: justify;">We offer fully customized, user-friendly, efficient, and secure custom software to support all business operations.
							</p>
					...
					<div class="col-lg-6">
						<div class="about-img-wrapper mb-30">
							<img src="img/software.jpg" class="img-fluid" alt="icon">
						</div>
					</div>
				</div>
			</div>
			...
			<div class="container">
				<div class="row">
					<div class="col-lg-12">
						<div class="section-title text-center mb-60">
							...
							<h2 class="sect-title text-heding2 mb-35 text-center" style="font-size: 25px;">Our  Software Development Services That We Offer</h2>
							<div class="bar"></div>
						</div>
					</div>
				</div>
				<div class="row">
					...
					<div class="col-lg-6 col-md-6">
						<div class="white-bg chose-box d-sm-flex align-items-center mb-30">
							<div class="chose-content pr-30 col-10">
								<h5 class="fs-20">CUSTOM SOFTWARE
                                    DEVELOPMENT</h5>
							</div>
					...
					<div class="col-lg-6 col-md-6">
						<div class="white-bg chose-box d-sm-flex align-items-center mb-30">
							<div class="chose-content pr-30 col-10">
								<h5 class="fs-20">HRM SOFTWARE</h5>
							</div>
					...
					<div class="col-lg-6 col-md-6">
						<div class="white-bg chose-box d-sm-flex align-items-center mb-30">
							<div class="chose-content pr-30 col-10">
								<h5 class="fs-20">ACCOUNT MANAGEMENT
                                    SOFTWARE</h5>
							</div>
                    ...
                    <div class="col-lg-6 col-md-6">
						<div class="white-bg chose-box d-sm-flex align-items-center mb-30">
							<div class="chose-content pr-30 col-10">
								<h5 class="fs-20">PAYROLL SOLUTION</h5>
							</div>
							<h3 class="number-text">06</h3>
						</div>
					</div>
                    <div class="col-lg-6 col-md-6">
						<div class="white-bg chose-box d-sm-flex align-items-center mb-30">
							<div class="chose-content pr-30 col-10">
								<h5 class="fs-20">NGO MANAGEMENT
                                    SOFTWARE</h5>
							</div>
							<h3 class="number-text">07</h3>
						</div>
					</div>
				</div>
			</div>
